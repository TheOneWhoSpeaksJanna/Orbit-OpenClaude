...
class DeepSeekProvider(private val httpClient: OkHttpClient) : AiProvider {
    ...
    override suspend fun generateContent(
        ...
        try {
            ...
            val requestModel = if (model.isNotBlank()) model else ApiConfig.DEEPSEEK_DEFAULT_MODEL
            ...
            val request = Request.Builder()
                .url(ApiConfig.DEEPSEEK_CHAT_URL)
            ...
            if (response.isSuccessful && responseBody != null) {
                ...
                if (!text.isNullOrBlank()) {
                    ...
                    AiResult.Error("Empty response from DeepSeek.")
                }
            } else {
    ...
    override val metadata: ProviderMetadata = ProviderMetadata(
        ...
        models = listOf(
            ApiConfig.DEEPSEEK_DEFAULT_MODEL,
            "deepseek-reasoner",
            "deepseek-coder"
        ),
        supportsStreaming = true,
        requiresApiKey = true,
        defaultModel = ApiConfig.DEEPSEEK_DEFAULT_MODEL
    )
